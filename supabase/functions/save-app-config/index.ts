...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Validate config_key
    const validKeys = ["video_config", "vip_config", "white_label_config", "global_default_categories", "payment_config", "youtube_channel", "social_links", "platform_settings", "platform_plans"];
