...
export default function PrivacidadePage() {
  ...
  useEffect(() => {
    document.title = `${t("privacy.title")} | MyTingleBox`;
  }, [t]);
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-sm text-white/50 leading-relaxed">{t("privacy.summaryDesc")}</p>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h2 className="font-display text-lg font-semibold mb-2">{t(`privacy.section${i}Title`)}</h2>
                <p className="text-[15px] text-white/55 leading-relaxed">{t(`privacy.section${i}Text`)}</p>
              </div>
            </div>
          </motion.section>
        ))}
