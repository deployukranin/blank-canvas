              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full h-11 border-white/[0.08] bg-white/[0.04] hover:bg-white/[0.08] text-white font-medium gap-3"
                  ...
                  <div className="relative my-4">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-[#111111] px-2 text-gray-500">ou com email</span>
                    </div>
                  </div>
