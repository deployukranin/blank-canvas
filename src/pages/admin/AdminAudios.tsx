...
import { Save, Plus, Trash2, Headphones } from 'lucide-react';
...
const AdminAudios = () => {
  ...
  const updateCategory = (index: number, field: keyof AudioCategory, value: string | number) => {
    if (!config) return;
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <p className="text-sm text-muted-foreground">
            Configure as categorias e preços de áudios personalizados
          </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      ...
                      onChange={e => updateCategory(index, 'basePrice', parseFloat(e.target.value) || 0)}
                    />
                  </div>
                  <Button
                    size="icon"
