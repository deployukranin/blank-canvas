...
const menuItems = [
  { path: '/admin-master', icon: LayoutDashboard, label: 'Dashboard' },
  { path: '/admin-master/tenants', icon: Store, label: 'Plataformas' },
  { path: '/admin-master/ranking', icon: TrendingUp, label: 'Ranking' },
  { path: '/admin-master/configuracoes', icon: Settings, label: 'Configurações' },
];
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      >
        ...
        <div className="p-3 border-t border-purple-500/10 shrink-0">
          <Button
            variant="ghost"
            className="w-full justify-start gap-3 text-red-400/70 hover:text-red-400 hover:bg-red-500/10 text-sm"
