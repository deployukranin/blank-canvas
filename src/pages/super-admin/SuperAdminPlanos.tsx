...
const defaultPlans: PlanConfig[] = [
  ...
  },
  {
    ...
    priceBRL: 129.90,
    priceUSD: 24.90,
    features_pt: ['Tudo do mensal', 'Até 2.000 usuários', 'Domínio personalizado', 'Suporte prioritário', 'Relatórios avançados'],
    features_en: ['All monthly features', 'Up to 2,000 users', 'Custom domain', 'Priority support', 'Advanced reports'],
    features_es: ['Todo del mensual', 'Hasta 2.000 usuarios', 'Dominio personalizado', 'Soporte prioritario', 'Reportes avanzados'],
    highlight: true,
    discount: '-13%',
  },
  {
    ...
    priceBRL: 449.90,
    priceUSD: 89.90,
    features_pt: ['Tudo do trimestral', 'Usuários ilimitados', 'API personalizada', 'Suporte VIP 24h', 'Analytics premium', 'Backup diário'],
    features_en: ['All quarterly features', 'Unlimited users', 'Custom API', 'VIP 24h support', 'Premium analytics', 'Daily backup'],
    features_es: ['Todo del trimestral', 'Usuarios ilimitados', 'API personalizada', 'Soporte VIP 24h', 'Analytics premium', 'Backup diario'],
    discount: '-25%',
  },
];
